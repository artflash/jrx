<?php return array (
  ...
  'author' => '灵创石',
  'dirname' => 'newjrx',
  'homepage' => 'http://jianrenxiao.com',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|newjrx|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|newjrx|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|newjrx|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|newjrx|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|newjrx|wap' => 
    array (
    ...
    'templates|newjrx|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|newjrx|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|newjrx|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|newjrx|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|newjrx|yp' => 
    ...
    'templates|newjrx|yp|com_default' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|newjrx|comment' => 
    array (
