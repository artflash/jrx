...
<title>¼úÈËÐ¦ - <?php echo L('member','','member').L('manage_center');?></title>
<link href="<?php echo CSS_PATH;?>jrx/reset.css" rel="stylesheet" type="text/css" />
<link href="<?php echo CSS_PATH;?>table_form.css" rel="stylesheet" type="text/css" />
<link href="<?php echo CSS_PATH;?>jrx/memberFooter.css" rel="stylesheet" type="text/css" />
...
.form-login{ width:440px; padding-left:40px; margin-bottom:20px}
...
#footer{line-height:24px;width:1000px; margin:auto;}
...
<div id="header">
	<div class="content">
	<div class="logo"><a href="<?php echo $siteinfo['domain'];?>"><img src="<?php echo IMG_PATH;?>jrx/systemImg/logo2.png"/></a></div>
...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
        ...
        <div class="input">
			<label><?php echo L('checkcode');?>£º</label><input type="text" id="code" name="code" size="8" class="input-text"><?php echo form::checkcode('code_img', '5', '14', 120, 26);?>
		</div>
        <div class="take">
