...
<title>贱人笑 - <?php echo L('member','','member').L('manage_center');?></title>
...
#footer{line-height:24px;width:1000px; margin:auto; padding:12px 0; margin-top:52px;}
...
<div id="header">
	<div class="content">
	<div class="logo"><a href="<?php echo $siteinfo['domain'];?>"><img src="<?php echo IMG_PATH;?>jrx/systemImg/logo2.png" width=""/></a></div>
    <span class="log"></span>
    </div>
</div>
